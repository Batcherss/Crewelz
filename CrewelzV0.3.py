...
def configurator():
    ...
    class ConfigWindow(QtWidgets.QWidget):
        ...
        def initUI(self):
            ...
            self.esp_mode_cb.addItems(["Только враги", "Всех сразу"])
            ...
            self.hp_bar_rendering_cb = QtWidgets.QCheckBox("Рисовать HP-Bar")
            ...
            self.nickname_cb = QtWidgets.QCheckBox("Писать ники")
            ...
            trigger_layout.addWidget(QtWidgets.QLabel("Кейбинд:"))
            ...
            aim_label = QtWidgets.QLabel("Аим-Ассист настройки")
            aim_label.setAlignment(QtCore.Qt.AlignCenter)
            aim_layout.addWidget(aim_label)
        
            self.aim_active_cb = QtWidgets.QCheckBox("Включить аим?")
            ...
            aim_layout.addWidget(QtWidgets.QLabel("Радиус:"))
            ...
            aim_layout.addWidget(QtWidgets.QLabel("Кейбинд:"))
            ...
            aim_layout.addWidget(QtWidgets.QLabel("Мод аима:"))
            aim_layout.addWidget(self.aim_mode_cb)
        
            self.aim_mode_distance_cb = QtWidgets.QComboBox()
            self.aim_mode_distance_cb.addItems(["Ближе к прицелу", "Ближе в 3D"])
            ...
            aim_layout.addWidget(QtWidgets.QLabel("Дистанция аима:"))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            pass
    print("Запускаем Crewelz client!")
    time.sleep(2)
